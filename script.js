...
//let celkovaCena = 0
let celkovaCena //u let není potřeba inicializovat, stačí deklarovat
...
<p>Počet kusů: ${pocetKusu}</p>
<p>Cena za kus: ${celkovaCena / pocetKusu} Kč</p>
<p>Celková cena je: ${celkovaCena} Kč</p>
`
